...
<div id="page-footer">
	...
	<div class="navbar">
		...
		<ul class="linklist">
			...
			<li class="icon-forum"><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" accesskey="f"><?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?></a></li>
...
//-->
	...
	<div class="copyright">Powered by <a href="http://www.phpbb.com/">phpBB</a> &copy; 2000, 2002, 2005, 2007 phpBB Group<BR />
        Genesis-sf_menu style by Matthew Greet 2011, based in prosilver style<BR />
        <A HREF="/forum/faq.php#f11r0">Terms and Conditions</A> | <A HREF="/forum/faq.php#f11r1">Privacy Policy</A>
