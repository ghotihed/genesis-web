...
<!--
	phpBB style name: genesis-sf_menu
	Based on style:   prosilver (this is the default phpBB3 style)
	Original author:  Tom Beddard ( http://www.subBlue.com/ )
	Modified by: Matthew Greet
...
<SCRIPT SRC="/scripts/controls.js" LANGUAGE="JavaScript" TYPE="text/javascript"></SCRIPT>
...
<body id="phpbb" class="section-<?php echo (isset($this->_rootref['SCRIPT_NAME'])) ? $this->_rootref['SCRIPT_NAME'] : ''; ?> <?php echo (isset($this->_rootref['S_CONTENT_DIRECTION'])) ? $this->_rootref['S_CONTENT_DIRECTION'] : ''; ?>" STYLE="padding-left: 160px;" onload="selectMenu('forumMenu')">
 
    <DIV CLASS="menu" ID="menu">
        <A href="/" target="_parent"><IMG border="0" src="/images/LogoWhite.png" width="165" height="140"></A>
        
        <A class="menu" href="/index.shtml" target="_parent" id="newsMenu">News</A> 
        <DIV id="newsMenuGroup" style="height: 0px; visibility: hidden;" class="menuGroup">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
        </DIV>
        
        <A class="menu" href="/forum/" id="forumMenu" target="_parent">Forum</A> 
        <DIV id="forumMenuGroup" style="height: 0px; visibility: hidden;" class="menuGroup">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
        </DIV>
        
        <A class="menu" href="/gallery/gallery.shtml" target="_parent" id="galleryMenu">Gallery</A>
        <DIV id="galleryMenuGroup" style="height: 0px; visibility: hidden;" class="menuGroup">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
        </DIV>
        
        <A class="menu" href="/ourWork/theUniverseToday.shtml" target="_parent" id="ourWorkMenu">Our Work</A> 
        <DIV id="ourWorkMenuGroup" style="height: 0px; visibility: hidden;">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
        </DIV>
        
        <A class="menu" href="/upcoming/events.shtml" target="_parent" id="upcomingMenu">Upcoming</A> 
        <DIV id="upcomingMenuGroup" style="height: 0px; visibility: hidden;" class="menuGroup">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
        </DIV>
        
        <A class="menu" href="/review/events.shtml" target="_parent" id="reviewsMenu">Reviews</A> 
        <DIV id="reviewMenuGroup" style="height: 0px; visibility: hidden;" class="menuGroup">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
        </DIV>
        
        <A class="menu" href="/aboutUs/aboutUs.shtml" target="_parent" id="aboutUsMenu">About Us</A> 
        <DIV id="aboutUsMenuGroup" style="height: 0px; visibility: hidden;" class="menuGroup">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
        </DIV>
        
        <A class="menu" href="/links/ourFriends.shtml" target="_parent" id="linksMenu">Links</A> 
        <DIV id="linksMenuGroup" style="height: 0px; visibility: hidden;" class="menuGroup">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
        </DIV>

       <A class="menu" href="/archive/index2011.shtml" target="_parent" id="archiveMenu">Archive</A> 
       <DIV id="archiveMenuGroup" style="height: 0px; visibility: hidden;" class="menuGroup">
            <A class="submenu" href="/index.shtml" target="_parent">Dummy</A>
       </DIV>
    </DIV>
...
<div id="wrap">
	...
	<H1 STYLE="text-align: center; font-family: Verdana; font-weight: bold; font-size: 12pt; color: black; margin-top: 10px;">Forum</H1>
	<div id="page-header">
		<div class="navbar">
			<div class="inner"><span class="corners-top"><span></span></span>

			<ul class="linklist navlinks">
				<li class="icon-home"><a href="/" accesskey="h">Home</a></li>
				<li class="icon-forum"><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" accesskey="f"><?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?></a> <?php $_navlinks_count = (isset($this->_tpldata['navlinks'])) ? sizeof($this->_tpldata['navlinks']) : 0;if ($_navlinks_count) {for ($_navlinks_i = 0; $_navlinks_i < $_navlinks_count; ++$_navlinks_i){$_navlinks_val = &$this->_tpldata['navlinks'][$_navlinks_i]; ?> <strong>&#8249;</strong> <a href="<?php echo $_navlinks_val['U_VIEW_FORUM']; ?>"><?php echo $_navlinks_val['FORUM_NAME']; ?></a><?php }} ?></li>
			...
			<ul class="linklist rightside">
				...
				<li class="icon-search"><a href="<?php echo (isset($this->_rootref['U_SEARCH'])) ? $this->_rootref['U_SEARCH'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SEARCH'])) ? $this->_rootref['L_SEARCH'] : ((isset($user->lang['SEARCH'])) ? $user->lang['SEARCH'] : '{ SEARCH }')); ?>"><?php echo ((isset($this->_rootref['L_SEARCH'])) ? $this->_rootref['L_SEARCH'] : ((isset($user->lang['SEARCH'])) ? $user->lang['SEARCH'] : '{ SEARCH }')); ?></a></li>
	...
	<div id="page-body">
		...
		<?php } $this->_tpl_include('announcement_centre.html'); ?>